...
import com.handmark.pulltorefresh.library.view.MyFooterLayout;
import com.handmark.pulltorefresh.library.view.MyHeaderLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected LoadingLayoutBase createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
		...
		if(mode==Mode.PULL_FROM_START){
			MyHeaderLayout header=new MyHeaderLayout(context);
			header.setVisibility(View.INVISIBLE);
			return  header;
		}else{
			MyFooterLayout footer=new MyFooterLayout(context);
